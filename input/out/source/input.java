...
public class PresetSaver {
    ...
    public void saveAndUpload() {
        ...
        try {
            URL uploadUrl = new URL(apiLink + "uid=" + userId + "&function=uploadPreset&presetNumber=" + this.idNumber + "&preset=" + data);
    ...
    public void downloadAndLoad() {
        try {
            URL uploadUrl = new URL(apiLink + "uid=" + userId + "&function=downloadPreset&presetNumber=" + this.idNumber);
            URLConnection urlConn = uploadUrl.openConnection();
            BufferedReader in = new BufferedReader(new InputStreamReader(urlConn.getInputStream()));
            String inputLine;
